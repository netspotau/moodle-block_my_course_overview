...
class block_my_course_overview_renderer extends plugin_renderer_base {
    ...
    protected function course_move_target($cid, $weight) {
        $url = new moodle_url('/blocks/my_course_overview/move.php', array('source' => $cid, 'target' => $weight));
        return html_writer::tag('a', html_writer::tag('span', get_string('movecoursehere', 'block_my_course_overview'),
    ...
    protected function activity_display($cid, $overview) {
        ...
        foreach (array_keys($overview) as $module) {
            ...
            if (get_string_manager()->string_exists("activity_$module", 'block_my_course_overview')) {
                $icontext .= get_string("activity_$module", 'block_my_course_overview');
            } else {
                $icontext .= get_string("activityoverview", 'block_my_course_overview', $module);
            }
    ...
    protected function collapsible_region_start($classes, $id, $caption, $userpref = '', $default = false) {
        ...
        $this->page->requires->js_init_call('M.block_my_course_overview.collapsible', array($id, $userpref, get_string('clicktohideshow')));
