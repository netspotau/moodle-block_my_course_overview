...
function block_my_course_overview_get_overviews($courses) {
...
function block_my_course_overview_update_mynumber($number) {
    global $DB, $USER;
...
function block_my_course_overview_update_myorder($sortorder) {
    global $DB, $USER;
...
function block_my_course_overview_get_child_shortnames($courseid) {
...
function block_my_course_overview_get_sorted_courses() {
    global $USER;
