...
require_once($CFG->dirroot.'/blocks/my_course_overview/locallib.php');

class block_my_course_overview extends block_base {
    /**
     * block initializations
     */
    public function init() {
        $this->title   = get_string('displaytitle', 'block_my_course_overview');
    }
    ...
    public function get_content() {
        ...
        if (!is_null($updatemynumber)) {
            block_my_course_overview_update_mynumber($updatemynumber);
        }
